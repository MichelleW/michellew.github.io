    ...
    return (
        <footer className="footer">
            <ul className="nav-links">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/michellewusf" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                    <a href="https://github.com/michellew" target="_blank" rel="noopener noreferrer">
